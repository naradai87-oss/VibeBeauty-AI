...
export default function LandingHero() {
  return (
    <div className="relative z-[50] max-w-4xl px-6 text-center">
      <div
        className="animate-fade-in-up inline-flex items-center gap-2 px-4 py-1.5 rounded-full luxury-glass border-vibe-silver/40 mb-10 shadow-luxury opacity-0"
      ...
      <h1 
        className="animate-fade-in-up heading-serif text-6xl md:text-9xl font-light text-vibe-charcoal leading-[1.1] mb-12 tracking-tighter opacity-0"
      ...
      <p
        className="animate-fade-in-up text-lg md:text-xl text-vibe-slate/80 max-w-xl mx-auto leading-relaxed mb-16 font-medium opacity-0"
      ...
      <div
        className="animate-fade-in-up flex flex-col items-center gap-8 opacity-0"
